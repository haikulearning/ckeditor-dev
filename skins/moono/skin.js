...
(function() {
	...
	// extension) available inside the "icons" folder.
		var icons = ( 'anchor,bgcolor,bidiltr,bidirtl,blockquote,' +
			'bold,bulletedlist,copy,' +
			'cut,find,' +
			'indent,italic,justifyblock,justifycenter,justifyleft,justifyright,' +
			'maximize,numberedlist,' +
			'outdent,paste,' +
			'pastetext,' +
			'redo,removeformat,' +
			'smiley,' +
			'source,specialchar,strike,subscript,' +
			'superscript,table,' +
			'textcolor,underline,undo,unlink' ).split( ',' );
